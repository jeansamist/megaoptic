...
export default function Promotion({cover, title, long_speech}) {
  ...
  return (
    <section className="section-promo"  style={{background: 'url("' + cover + '") no-repeat center / cover'}}>
      <div className="content">
        <motion.div {...MOTIONSSETTINGS.sectionTitle} className="promo-title">{title}</motion.div>
