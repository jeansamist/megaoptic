      ...
      setservices([
        {
          ...
          description:
            "Suscipit consequatur sunt perspiciatis ipsa soluta neque error, enim voluptas explicabo commodi amet unde itaque voluptates!",
          link: "#",
        },
        {
          cover: serviceCover2,
    ...
    <div className="view home-view">
      ...
      <div className="page-content">
        <section className="soldes-presentation">
          <motion.div
            {...MOTIONSSETTINGS.sectionTitle}
            className="title title-dot"
          >
            {solde ? "Soldes" : "Decouvrer"} Sur Le Site
          </motion.div>
        ...
        <section className="category-presentation">
          <motion.div
            ...
            className="title title-dot"
          >
            Faites Vos Commades Depuis Le Site
          </motion.div>
          <div className="categories">
            {categories.map((category, key) => (
              <motion.div
                {...MOTIONSSETTINGS.card2}
                transition={{ ...TRANSITION, delay: -0.5 + (key + 2) / 2 }}
              >
        ...
        <section className="services-presentation">
          <motion.div
            ...
            className="title title-dot"
          >
            Services D'optometrie Complets
          </motion.div>
          <motion.div {...MOTIONSSETTINGS.sectionText} className="text">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Autem nam
            distinctio optio fugit eligendi sapiente corporis ipsam, quis sit
            pariatur id et nemo labore placeat rerum commodi officia at
            suscipit.
          </motion.div>
        ...
        <section className="section-infos">
          ...
          <div className="infos">
            ...
            <InfoCard
              ...
              details="Obtenez rapidement vos lunettes"
            />
            <InfoCard
              Ico={FaShieldAlt}
              title="Garantie"
              details="Garanties limite sur nos produits"
            />
          </div>
        </section>
      </div>
