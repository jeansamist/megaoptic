...
function Modal({ image, message, active = false }) {
  return (<div className={'modal-action ' + (active ? 'active ' : '')}>
    <div className="modal">
      <div className="animation">
        <img src={outlineImage} alt="" className='outline' />
        <img src={image ?  image : checkImage} alt="" className='illustration' />
      </div>
      {message ? <h3 style={{textAlign: 'center', padding: '0 0.5em', marginTop: '0.5em'}}>{message}</h3> : ''}
    </div>
  </div>)
}
        ...
        <section className="form-contact">
          <div className="w1 w2">
            ...
            <>
                  ...
                  <tbody>
                    {
                      products.map(({cover, color, price, name}, key) => (
                        <motion.tr {...MOTIONSSETTINGS.card2} transition={{...TRANSITION}} key={key}>
              ...
              <motion.h2 {...MOTIONSSETTINGS.sectionText} style={{textAlign: 'center', margin: '1em 0'}}>Remplissez le formulaire de pour pouvoir avoir une facture</motion.h2>
              <motion.div {...MOTIONSSETTINGS.card2} transition={{...TRANSITION}} className="form">
              ...
              <motion.div {...MOTIONSSETTINGS.card2} transition={{...TRANSITION}} className="grid-2" style={{marginTop: '1em'}}>
